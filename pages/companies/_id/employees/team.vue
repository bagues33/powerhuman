        ...
        <section class="pt-[50px]">
            ...
            <form>
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:gap-10 lg:gap-3 mb-[50px]">
                    ...
                    <div v-else class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-for="team in teams.data.data.data" :key="team.id">
                        <input type="radio" @click="updateTeamId" :value="team.id" name="team_id" id="productGrowth"
